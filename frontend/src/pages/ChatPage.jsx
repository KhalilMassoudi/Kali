...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col" style={{ height: 'calc(100vh - 4rem)' }}>
      <div className="flex flex-col flex-1 px-5 py-5 min-h-0 w-full">
        <div
        ...
        >
          ...
          <div
            ...
            style={{ borderBottom: '1px solid rgba(26,51,84,0.8)' }}
          >
            ...
            {!isEmpty && (
              <button
                ...
                className="flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold text-slate-400 hover:text-red-400 transition-colors"
            ...
            {isEmpty ? (
              <div className="flex flex-col items-center justify-center h-full gap-6 px-6 py-10 text-center">
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, rgba(14,165,233,0.15), rgba(56,189,248,0.05))', border: '1px solid rgba(14,165,233,0.2)' }}
                >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 w-full max-w-xl">
                  {SUGGESTIONS.map((s) => (
                    <button
                      ...
                      className="text-left rounded-xl px-4 py-3 text-xs text-slate-300 hover:text-white transition-all hover:-translate-y-0.5"
          ...
          {/* Input */}
          <div className="shrink-0 p-4" style={{ borderTop: '1px solid rgba(26,51,84,0.8)' }}>
            <div
              ...
              onBlur={(e) => e.currentTarget.style.borderColor = 'rgba(26,51,84,0.8)'}
            >
              <textarea
                ref={textareaRef}
                value={input}
              ...
              <button
                ...
                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed hover:opacity-80"
